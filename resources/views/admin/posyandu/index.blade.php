<x-app title="Posyandu">
                    ...
                    <div class="card mb-4">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <div class="ms-auto d-flex gap-2">
                                ...
                                <a href="{{ route('posyandu.create') }}" class="btn btn-sm btn-primary">Tambah Data</a>
                            </div>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
    ...
    <form id="bulkDeleteForm" action="{{ route('posyandu.bulk-destroy') }}" method="POST" class="d-none">
        @csrf
    ...
    @push('scripts')
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                let selectedIds = [];
                const table = document.getElementById('posyanduTable');
                ...
                bulkDeleteBtn.addEventListener('click', function() {
                    Swal.fire({
                        ...
                        text: "Semua data posyandu terpilih (" + selectedIds.length + " data) akan dihapus permanen!",
                        icon: 'warning',
